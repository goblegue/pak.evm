...
void AdminResultPage::setupUi()
{
    ...
    electionListView->setStyleSheet(
    ...
    rightContainer->setStyleSheet("QWidget#rightContainer { background-color: white; border: 2px "
                                  "solid #BDC3C7; border-radius: 10px; }");
    ...
    rightTitleLabel->setStyleSheet(
        "font-size: 24px; font-weight: bold; color: #3b5998; border: none;");

    loadBtn = new QPushButton("📂 Load Result File", this);
    loadBtn->setCursor(Qt::PointingHandCursor);
    loadBtn->setFixedSize(180, 40);
    loadBtn->setStyleSheet("QPushButton { background-color: #3b5998; color: white; border-radius: "
                           "6px; font-size: 14px; font-weight: bold; border: none; }"
    ...
    chartScrollArea->setStyleSheet("QScrollArea { border: 2px solid #ECF0F1; border-radius: 6px; "
    ...
    statsFrame->setStyleSheet(
        "QFrame { background-color: #F8F9F9; border: 2px solid #3b5998; border-radius: 8px; }");
    ...
    winnerLabel->setStyleSheet(
        "font-size: 20px; color: #27AE60; font-weight: 900; border: none;"); // Highlight winner
    ...
    cancelBtn->setStyleSheet(
        "QPushButton { background-color: transparent; color: #3b5998; border: 2px solid #3b5998; "
    ...
    saveBtn->setStyleSheet("QPushButton { background-color: #3b5998; color: white; border-radius: "
                           "6px; font-size: 16px; font-weight: bold; border: none; }"
                           "QPushButton:hover { background-color: #4b6ea8; }");
